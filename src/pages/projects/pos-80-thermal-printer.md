...
description: "An Astro-based web interface for controlling a POS-80 thermal printer Connected to a Raspberry Pi."
---

An Astro-based web interface for controlling a POS-80 thermal printer connected to a Raspberry Pi. This application allows you to print text and images directly from your browser using a modern, responsive UI.
